...
Qiita <- R6::R6Class(
  ...
  public = list(
    ...
    get_tag           = function(tag_id = NULL, user_id = NULL) qiita_get_tag(url = self$url, token = self$token, tag_id = tag_id, user_id = user_id),
    get_following_tag = function(user_id) qiita_get_following_tag(url = self$url, token = self$token, user_id = user_id),
    delete_tagfollow  = function(tag_id) qiita_delete_tagfollow(url = self$url, token = self$token, tag_id = tag_id),
    get_tagfollow     = function(tag_id) qiita_get_tagfollow(url = self$url, token = self$token, tag_id = tag_id),
    put_tagfollow     = function(tag_id) qiita_put_tagfollow(url = self$url, token = self$token, tag_id = tag_id),
    get_stocker       = function(item_id) qiita_get_stocker(url = self$url, token = self$token, item_id = item_id),
    get_user          = function(user_id) qiita_get_user(url = self$url, token = self$token, user_id = user_id),
    get_followee      = function(user_id) qiita_get_followee(url = self$url, token = self$token, user_id = user_id),
    get_follower      = function(user_id) qiita_get_follower(url = self$url, token = self$token, user_id = user_id),
    delete_userfollow = function(user_id) qiita_delete_userfollow(url = self$url, token = self$token, user_id = user_id),
    get_userfollow    = function(user_id) qiita_get_userfollow(url = self$url, token = self$token, user_id = user_id),
    ...
    get_comment       = function(comment_id = NULL, item_id = NULL) qiita_get_comment(url = self$url, token = self$token, comment_id = comment_id, item_id = item_id),
    ...
    get_item          = function(item_id = NULL, tag_id = NULL, user_id = NULL, query = NULL) qiita_get_item(url = self$url, token = self$token, item_id = item_id, tag_id = tag_id, user_id = user_id, query = query),
    ...
    get_stock         = function(item_id = NULL, user_id = NULL) qiita_get_stock(url = self$url, token = self$token, item_id = item_id, user_id = user_id),
